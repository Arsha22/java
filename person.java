...
class Employee extends Teacher2
{
 int Empid;
 String Company_name;
 ...
 public class person extends Employee{
     ...
     String Department;
     String Teacherid;
    person(String name,String gender,String address,int age,int empid, String company_name, String qualification,long salary, String subject, String department, String teacherid){
    ...
    void display(){
     ...
     public static void main(String[] args) {
        ...
        for(int i =0;i<num;i++)
        {
            ...
            System.out.println("\n Teacher Id: ");
            String n =sc.next();
            arr[i]=new person(a,b,c,d,e,f,g,h,k,l,n);
        }
        sc.close();
